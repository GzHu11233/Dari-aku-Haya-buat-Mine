...
const nomor_hp_yang_ngirim = "+6285156635128";
const nama_yang_ngirim = "Gilang dan Haya";

// nama
const nama = "Minces Cantik";
...
const kata = [
  ...
  `Jaga kesehatan yaaa 🙃`,
  `Selalu tersenyum, meskipun tiap hari dimarahin aku ${nama}`,
  `Jangan lupa di makan 🍰 nya, walau virtual hehe`,
  `Sekali lagi selamat ulang tahun ${nama} semoga cepet sembuh aku sama haya dah kangen 🙌✨`,
];
